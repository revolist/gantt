...
import { RESOURCE_PLANNING_INDUSTRY_DEFINITION as definition } from './resource-planning.data';
...
@Component({
  selector: 'resource-planning-gantt-grid',
  standalone: true,
  imports: [RevoGrid],
  schemas: [NO_ERRORS_SCHEMA],
  encapsulation: ViewEncapsulation.None,
  styleUrls: ['../shared/industry-use-case.scss', './resource-planning.presentation.scss'],
...
export class ResourcePlanningGanttComponent implements OnDestroy {
