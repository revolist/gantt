...
import { MANUFACTURING_INDUSTRY_DEFINITION as definition } from './manufacturing.data';
...
@Component({
  selector: 'manufacturing-gantt-grid',
  standalone: true,
  imports: [RevoGrid],
  schemas: [NO_ERRORS_SCHEMA],
  encapsulation: ViewEncapsulation.None,
  styleUrls: ['../shared/industry-use-case.scss', './manufacturing.presentation.scss'],
...
export class ManufacturingGanttComponent implements OnDestroy {
