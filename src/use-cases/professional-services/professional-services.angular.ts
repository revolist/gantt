...
@Component({
  selector: 'professional-services-gantt-grid',
  standalone: true,
  imports: [RevoGrid],
  schemas: [NO_ERRORS_SCHEMA],
  encapsulation: ViewEncapsulation.None,
  styleUrls: ['../shared/industry-use-case.scss', './professional-services.presentation.scss'],
...
export class ProfessionalServicesGanttComponent implements OnDestroy {
