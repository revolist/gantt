...
@Component({
  selector: 'internal-tools-gantt-grid',
  standalone: true,
  imports: [RevoGrid],
  schemas: [NO_ERRORS_SCHEMA],
  encapsulation: ViewEncapsulation.None,
  styleUrls: ['../shared/industry-use-case.scss', './internal-tools.presentation.scss'],
...
export class InternalToolsGanttComponent implements OnDestroy {
